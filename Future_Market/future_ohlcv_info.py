...
BASE_URL = "https://web3api.io/api/v2/market/futures/ohlcv/information"
INSERT_SQL = '''INSERT INTO future_market_data.ohlcv_info (instrument, exchange,startdate,enddate)
...
def ohlcv_infomation_insert_data():
    ...
    data = response.json()
    if data['status'] != 200:
        print("Future ohlcv Info get data error!")
...
if __name__ == '__main__':
    ...
    if result_bool == True:
        print("Future ohlcv Rate Info is completed")