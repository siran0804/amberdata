...
BASE_URL = "https://web3api.io/api/v2/market/spot/vwap/pairs/information"
INSERT_SQL = '''INSERT INTO spot_market_data.global_vwap_pair_infomation (pair, startdate,enddate)
 VALUES (%(pair)s, %(startDate)s, %(endDate)s) ON CONFLICT (pair) DO NOTHING'''


def global_vwap_pair_infomation_insert_data():
    try:
...
if __name__ == '__main__':
    result_bool = global_vwap_pair_infomation_insert_data()
    if result_bool ==True:
