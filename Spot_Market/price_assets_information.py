...
BASE_URL = "https://web3api.io/api/v2/market/spot/prices/assets/information/"
INSERT_SQL = '''INSERT INTO spot_market_data.price_assets_infomation (asset, startdate,enddate)
 VALUES (%(asset)s, %(startDate)s, %(endDate)s) ON CONFLICT (asset) DO NOTHING'''


def price_assets_infomation_insert_data():
    try:
...
if __name__ == '__main__':
    result_bool = price_assets_infomation_insert_data()
    if result_bool ==True:
